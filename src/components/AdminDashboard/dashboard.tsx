          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2 card">
              <div className="card-header">
                ...
                <p className="card-description">Recent updates across your website</p>
              </div>
              <div className="card-content">
                  ...
                  {recentActivities.map(activity => (
                    <div key={activity.id} className="flex items-start p-3 hover:bg-gray-50 rounded-lg">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-sm text-muted-foreground">{activity.type} • {activity.author}</p>
                      </div>
            ...
            <div className="card">
              <div className="card-header">
                <h3 className="card-title">Website Analytics</h3>
                <p className="card-description">Last 30 days performance</p>
              </div>
